...
if (isset($_GET['action'])) {
    ...
    elseif ($_GET['action'] == 'add'){
        if (!empty($_POST['username']) && !empty($_POST['password']) && !empty($_POST['surname']) && !empty($_POST['family_name']) && !empty($_POST['gender']) && !empty($_POST['birth_date']) && !empty($_POST['is_logged'])) 
        {
